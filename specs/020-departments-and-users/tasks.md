...
- [x] **TASK-DU-001 Endurecer Department con TDD**
...
- [x] **TASK-DU-002 Endurecer Domain.User con TDD**
...
- [x] **TASK-DU-003 Definir paginación, DTOs y puertos neutrales**
...
- [x] **TASK-DU-004 Configurar mappings explícitos**
...
- [x] **TASK-DU-005 Implementar auditoría central**
...
- [x] **TASK-DU-006 Implementar transacción explícita compartida**
  - Requisitos: `REQ-USR-001`, `REQ-USR-003`, `REQ-USR-005..007`.
  - Diseño: `DES-DU-005`, `DES-DU-007`, `DES-DU-009`.
  - Implementar transacciones explícitas sobre el `ApplicationDbContext` scoped compartido; se evita una abstracción adicional en este showcase.
...
- [x] **TASK-DU-007 Implementar adapters/read services**
...
- [x] **TASK-DU-008 Generar migraciones incrementales dual-provider**
...
- [x] **TASK-DU-009 Implementar create/get Department**
...
- [x] **TASK-DU-010 Implementar list/update Department**
...
- [x] **TASK-DU-011 Implementar estado Department**
...
- [x] **TASK-DU-012 Implementar adapter administrativo Identity**
  - Requisitos: `REQ-USR-001`, `REQ-USR-003`, `REQ-USR-005..007`.
...
- [x] **TASK-DU-013 Implementar create/get User atómico**
...
- [x] **TASK-DU-014 Implementar list/update/asignación/roles User**
...
- [x] **TASK-DU-015 Implementar estado User y revocación**
...
- [x] **TASK-DU-016 Publicar endpoints Department**
...
- [x] **TASK-DU-017 Publicar endpoints User**
...
- [x] **TASK-DU-018 Completar seguridad y OpenAPI**
...
## Evidencia local del corte Departments and Users

- Implementación local: commits `bbb52af` (Departments) y `4ea1560` (Users); publicación remota diferida por solicitud del usuario.
- `dotnet format InternalOperations.slnx --verify-no-changes --no-restore`: exitoso.
